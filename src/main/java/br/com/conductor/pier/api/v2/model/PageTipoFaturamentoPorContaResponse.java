...
public class PageTipoFaturamentoPorContaResponse  {
  ...
  private List<TipoFaturamentoPorContaResponse> content = null;
  ...
  public List<TipoFaturamentoPorContaResponse> getContent() {
    return content;
  }
  public void setContent(List<TipoFaturamentoPorContaResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTipoFaturamentoPorContaResponse {\n");
