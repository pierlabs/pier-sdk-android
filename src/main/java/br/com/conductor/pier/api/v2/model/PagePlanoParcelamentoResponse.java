...
import br.com.conductor.pier.api.v2.model.PlanoParcelamentoResponse;
import java.util.*;
...
public class PagePlanoParcelamentoResponse  {
  ...
  private List<PlanoParcelamentoResponse> content = null;
  ...
  public List<PlanoParcelamentoResponse> getContent() {
    return content;
  }
  public void setContent(List<PlanoParcelamentoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PagePlanoParcelamentoResponse {\n");
