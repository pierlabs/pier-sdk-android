 ...
 **/
@ApiModel(description = "{{{page_maquineta_response_description}}}")
public class PageMaquinetaResponse  {
  
  @SerializedName("content")
  private List<MaquinetaResponse> content = null;
  ...
  public List<MaquinetaResponse> getContent() {
    return content;
  }
  public void setContent(List<MaquinetaResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageMaquinetaResponse {\n");
