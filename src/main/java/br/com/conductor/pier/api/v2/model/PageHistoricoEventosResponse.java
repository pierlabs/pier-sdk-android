...
import br.com.conductor.pier.api.v2.model.HistoricoEventosResponse;
import java.util.*;
...
/**
 * Lista of the historicEvents
 **/
@ApiModel(description = "Lista of the historicEvents")
public class PageHistoricoEventosResponse  {
  
  @SerializedName("content")
  private List<HistoricoEventosResponse> content = null;
  ...
  public List<HistoricoEventosResponse> getContent() {
    return content;
  }
  public void setContent(List<HistoricoEventosResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageHistoricoEventosResponse {\n");
