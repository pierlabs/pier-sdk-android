 ...
 **/
@ApiModel(description = "Lista de Transa\u00C3\u00A7\u00C3\u00B5es Correntes")
public class PageTransacoesCorrentes  {
  
  @SerializedName("content")
  private List<TransacoesCorrentes> content = null;
  ...
  public List<TransacoesCorrentes> getContent() {
    return content;
  }
  public void setContent(List<TransacoesCorrentes> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTransacoesCorrentes {\n");
