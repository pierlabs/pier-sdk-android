...
public class ReferenciaComercialAprovadoPersistValue  {
   ...
   **/
  @ApiModelProperty(value = "{{{referencia_comercial_aprovado_persist_razao_social_value}}}")
   ...
   **/
  @ApiModelProperty(value = "{{{referencia_comercial_aprovado_persist_nome_contrato_value}}}")
   ...
   **/
  @ApiModelProperty(value = "{{{referencia_comercial_aprovado_persist_ddd_value}}}")
   ...
   **/
  @ApiModelProperty(value = "{{{referencia_comercial_aprovado_persist_telefone_value}}}")
   ...
   **/
  @ApiModelProperty(value = "{{{referencia_comercial_aprovado_persist_email_value}}}")
