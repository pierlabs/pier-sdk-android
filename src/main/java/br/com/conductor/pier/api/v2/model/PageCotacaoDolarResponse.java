...
import br.com.conductor.pier.api.v2.model.CotacaoDolarResponse;
import java.util.*;
...
public class PageCotacaoDolarResponse  {
  
  @SerializedName("content")
  private List<CotacaoDolarResponse> content = null;
  ...
  public List<CotacaoDolarResponse> getContent() {
    return content;
  }
  public void setContent(List<CotacaoDolarResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageCotacaoDolarResponse {\n");
