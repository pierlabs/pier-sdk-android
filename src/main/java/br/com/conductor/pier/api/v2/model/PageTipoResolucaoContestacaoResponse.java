...
import br.com.conductor.pier.api.v2.model.CdtTipoResolucaoContestacao;
import java.util.*;
...
/**
 * Lista resolu\u00E7\u00E3o das contesta\u00E7\u00F5es
 **/
@ApiModel(description = "Lista resolu\u00E7\u00E3o das contesta\u00E7\u00F5es")
public class PageTipoResolucaoContestacaoResponse  {
  
  @SerializedName("content")
  private List<CdtTipoResolucaoContestacao> content = null;
  ...
  public List<CdtTipoResolucaoContestacao> getContent() {
    return content;
  }
  public void setContent(List<CdtTipoResolucaoContestacao> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTipoResolucaoContestacaoResponse {\n");
