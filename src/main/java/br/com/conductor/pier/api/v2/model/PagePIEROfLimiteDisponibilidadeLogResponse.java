...
import br.com.conductor.pier.api.v2.model.LimiteDisponibilidadeLogResponse;
import java.util.*;
...
public class PagePIEROfLimiteDisponibilidadeLogResponse  {
  
  @SerializedName("content")
  private List<LimiteDisponibilidadeLogResponse> content = null;
  ...
  public List<LimiteDisponibilidadeLogResponse> getContent() {
    return content;
  }
  public void setContent(List<LimiteDisponibilidadeLogResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PagePIEROfLimiteDisponibilidadeLogResponse {\n");
