 ...
 **/
@ApiModel(description = "Lista de Transfer\u00C3\u00AAncias")
public class LinkPageTransferenciaBancariaResponse  {
  
  @SerializedName("content")
  private List<LinkTransferenciaBancariaResponse> content = null;
  ...
  public List<LinkTransferenciaBancariaResponse> getContent() {
    return content;
  }
  public void setContent(List<LinkTransferenciaBancariaResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class LinkPageTransferenciaBancariaResponse {\n");
