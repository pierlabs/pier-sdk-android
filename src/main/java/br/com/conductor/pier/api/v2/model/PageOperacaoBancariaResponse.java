...
/**
 * Lista de opera\u00E7\u00F5es banc\u00E1rias
 **/
@ApiModel(description = "Lista de opera\u00E7\u00F5es banc\u00E1rias")
public class PageOperacaoBancariaResponse  {
  
  @SerializedName("content")
  private List<OperacaoBancariaResponse> content = null;
  ...
  public List<OperacaoBancariaResponse> getContent() {
    return content;
  }
  public void setContent(List<OperacaoBancariaResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageOperacaoBancariaResponse {\n");
