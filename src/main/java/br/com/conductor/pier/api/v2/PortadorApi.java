...
public class PortadorApi {
   ...
   * @return PagePortador
   */
  public PagePortador  listarUsingGET4 (Long idConta, Long idProduto, Long idPessoa, Long idParentesco, String tipoPortador, String nomeImpresso, Integer flagAtivo, Date dataCadastroPortador, Date dataCancelamentoPortador, Integer page, Integer limit) throws ApiException {
