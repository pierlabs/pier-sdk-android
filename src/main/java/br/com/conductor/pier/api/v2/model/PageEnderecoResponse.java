 ...
 **/
@ApiModel(description = "{{{page_endereco_response_description}}}")
public class PageEnderecoResponse  {
  
  @SerializedName("content")
  private List<EnderecoResponse> content = null;
  ...
  public List<EnderecoResponse> getContent() {
    return content;
  }
  public void setContent(List<EnderecoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageEnderecoResponse {\n");
