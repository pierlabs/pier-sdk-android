...
import br.com.conductor.pier.api.v2.model.StatusArquivoResponse;
import java.util.*;
...
public class PageStatusArquivoResponse  {
  ...
  private List<StatusArquivoResponse> content = null;
  ...
  public List<StatusArquivoResponse> getContent() {
    return content;
  }
  public void setContent(List<StatusArquivoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageStatusArquivoResponse {\n");
