...
/**
 * Lista de Controles de limites de cart\u00F5es
 **/
@ApiModel(description = "Lista de Controles de limites de cart\u00F5es")
public class PageControleLimiteCartaoResponse  {
  
  @SerializedName("content")
  private List<ControleLimiteCartaoResponse> content = null;
  ...
  public List<ControleLimiteCartaoResponse> getContent() {
    return content;
  }
  public void setContent(List<ControleLimiteCartaoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageControleLimiteCartaoResponse {\n");
