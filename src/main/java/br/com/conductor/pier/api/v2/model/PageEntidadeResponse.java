...
import br.com.conductor.pier.api.v2.model.EntidadeResponse;
import java.util.*;
 ...
 **/
@ApiModel(description = "{{{page_entidade_response_description}}}")
public class PageEntidadeResponse  {
  
  @SerializedName("content")
  private List<EntidadeResponse> content = null;
  ...
  public List<EntidadeResponse> getContent() {
    return content;
  }
  public void setContent(List<EntidadeResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageEntidadeResponse {\n");
