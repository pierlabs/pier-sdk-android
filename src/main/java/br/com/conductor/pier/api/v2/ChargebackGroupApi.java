...
public class ChargebackGroupApi {
   ...
   */
  public PageCodigoChargebackResponse  listarCodigos (Long grupoChargebackId, List<String> sort, Integer page, Integer limit, Long id, String descricao, Boolean flagAtm, Long grupoChargebackId2) throws ApiException {
    Object postBody = null;
