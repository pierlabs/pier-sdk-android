 ...
 **/
@ApiModel(description = "List of user devices")
public class PageControleSegurancaDispositivoResponse  {
  
  @SerializedName("content")
  private List<ControleSegurancaDispositivoResponse> content = null;
  ...
  public List<ControleSegurancaDispositivoResponse> getContent() {
    return content;
  }
  public void setContent(List<ControleSegurancaDispositivoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageControleSegurancaDispositivoResponse {\n");
