...
/**
 * List the proposals registred in the system
 **/
@ApiModel(description = "List the proposals registred in the system")
public class PagePropostaResponse  {
  
  @SerializedName("content")
  private List<PropostaResponse> content = null;
  ...
  public List<PropostaResponse> getContent() {
    return content;
  }
  public void setContent(List<PropostaResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PagePropostaResponse {\n");
