...
public class PageTipoProdutoResponse  {
  
  @SerializedName("content")
  private List<TipoProdutoResponse> content = null;
  ...
  public List<TipoProdutoResponse> getContent() {
    return content;
  }
  public void setContent(List<TipoProdutoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTipoProdutoResponse {\n");
