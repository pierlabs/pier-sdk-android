...
public class PagePortadorResponse  {
  ...
  private List<PortadorResponse> content = null;
  ...
  public List<PortadorResponse> getContent() {
    return content;
  }
  public void setContent(List<PortadorResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PagePortadorResponse {\n");
