...
import br.com.conductor.pier.api.v2.model.CodigoChargebackResponse;
import java.util.*;
 ...
 **/
@ApiModel(description = "Chargeback Code List")
public class PageCodigoChargebackResponse  {
  
  @SerializedName("content")
  private List<CodigoChargebackResponse> content = null;
  ...
  public List<CodigoChargebackResponse> getContent() {
    return content;
  }
  public void setContent(List<CodigoChargebackResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageCodigoChargebackResponse {\n");
