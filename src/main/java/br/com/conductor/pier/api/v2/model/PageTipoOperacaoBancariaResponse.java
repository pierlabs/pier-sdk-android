...
/**
 * Lista os tipos de opera\u00E7\u00E3o banc\u00E1ria da conta digital
 **/
@ApiModel(description = "Lista os tipos de opera\u00E7\u00E3o banc\u00E1ria da conta digital")
public class PageTipoOperacaoBancariaResponse  {
  
  @SerializedName("content")
  private List<TipoOperacaoBancariaResponse> content = null;
  ...
  public List<TipoOperacaoBancariaResponse> getContent() {
    return content;
  }
  public void setContent(List<TipoOperacaoBancariaResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTipoOperacaoBancariaResponse {\n");
