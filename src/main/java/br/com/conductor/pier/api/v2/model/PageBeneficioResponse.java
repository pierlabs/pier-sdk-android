...
/**
 * Lista paginada da resposta do benef\u00EDcio
 **/
@ApiModel(description = "Lista paginada da resposta do benef\u00EDcio")
public class PageBeneficioResponse  {
  
  @SerializedName("content")
  private List<BeneficioResponse> content = null;
  ...
  public List<BeneficioResponse> getContent() {
    return content;
  }
  public void setContent(List<BeneficioResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageBeneficioResponse {\n");
