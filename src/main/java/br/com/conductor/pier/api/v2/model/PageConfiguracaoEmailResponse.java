...
public class PageConfiguracaoEmailResponse  {
  ...
  private List<ConfiguracaoEmailResponse> content = null;
  ...
  public List<ConfiguracaoEmailResponse> getContent() {
    return content;
  }
  public void setContent(List<ConfiguracaoEmailResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageConfiguracaoEmailResponse {\n");
