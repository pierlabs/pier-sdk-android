...
public class PageArquivoResponse  {
  ...
  private List<ArquivoResponse> content = null;
  ...
  public List<ArquivoResponse> getContent() {
    return content;
  }
  public void setContent(List<ArquivoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageArquivoResponse {\n");
