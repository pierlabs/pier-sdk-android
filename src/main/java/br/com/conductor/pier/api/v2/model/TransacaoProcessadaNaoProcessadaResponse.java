...
public class TransacaoProcessadaNaoProcessadaResponse  {
   ...
   **/
  @ApiModelProperty(value = "Atributo que representa o c\u00F3digo de identifica\u00E7\u00E3o do tipo de ajuste")
   ...
   **/
  @ApiModelProperty(value = "Identificador do tipo de transacao n\u00E3o processada")
