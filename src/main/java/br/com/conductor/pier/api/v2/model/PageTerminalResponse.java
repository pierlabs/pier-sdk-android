 ...
 * List of terminals
 **/
@ApiModel(description = "List of terminals")
public class PageTerminalResponse  {
  
  @SerializedName("content")
  private List<TerminalResponse> content = null;
  ...
  public List<TerminalResponse> getContent() {
    return content;
  }
  public void setContent(List<TerminalResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTerminalResponse {\n");
