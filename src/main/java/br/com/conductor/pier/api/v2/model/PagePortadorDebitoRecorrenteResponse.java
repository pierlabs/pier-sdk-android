...
/**
 * Lista de debitos recorrentes do portador.
 **/
@ApiModel(description = "Lista de debitos recorrentes do portador.")
public class PagePortadorDebitoRecorrenteResponse  {
  
  @SerializedName("content")
  private List<PortadorDebitoRecorrenteResponse> content = null;
  ...
  public List<PortadorDebitoRecorrenteResponse> getContent() {
    return content;
  }
  public void setContent(List<PortadorDebitoRecorrenteResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PagePortadorDebitoRecorrenteResponse {\n");
