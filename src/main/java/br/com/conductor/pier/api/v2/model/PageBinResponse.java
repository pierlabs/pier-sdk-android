...
import br.com.conductor.pier.api.v2.model.BinResponse;
import java.util.*;
...
public class PageBinResponse  {
  ...
  private List<BinResponse> content = null;
  ...
  public List<BinResponse> getContent() {
    return content;
  }
  public void setContent(List<BinResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageBinResponse {\n");
