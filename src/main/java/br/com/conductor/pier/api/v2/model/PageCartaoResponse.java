 ...
 * List of the cards
 **/
@ApiModel(description = "List of the cards")
public class PageCartaoResponse  {
  
  @SerializedName("content")
  private List<CartaoResponse> content = null;
  ...
  public List<CartaoResponse> getContent() {
    return content;
  }
  public void setContent(List<CartaoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageCartaoResponse {\n");
