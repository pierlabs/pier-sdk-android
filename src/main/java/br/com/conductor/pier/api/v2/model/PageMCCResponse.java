...
import br.com.conductor.pier.api.v2.model.MCCResponse;
import java.util.*;
 ...
 * List of the MCCs
 **/
@ApiModel(description = "List of the MCCs")
public class PageMCCResponse  {
  
  @SerializedName("content")
  private List<MCCResponse> content = null;
  ...
  public List<MCCResponse> getContent() {
    return content;
  }
  public void setContent(List<MCCResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageMCCResponse {\n");
