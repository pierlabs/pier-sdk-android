...
public class PageInstituicoesPagamentoResponse  {
  
  @SerializedName("content")
  private List<InstituicaoPagamentoResponse> content = null;
  ...
  public List<InstituicaoPagamentoResponse> getContent() {
    return content;
  }
  public void setContent(List<InstituicaoPagamentoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageInstituicoesPagamentoResponse {\n");
