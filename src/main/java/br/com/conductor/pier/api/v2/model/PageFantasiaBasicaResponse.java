 ...
 **/
@ApiModel(description = "Representa\u00C3\u00A7\u00C3\u00A3o da resposta do recurso de fantasia b\u00C3\u00A1sica")
public class PageFantasiaBasicaResponse  {
  
  @SerializedName("content")
  private List<FantasiaBasicaResponse> content = null;
  ...
  public List<FantasiaBasicaResponse> getContent() {
    return content;
  }
  public void setContent(List<FantasiaBasicaResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageFantasiaBasicaResponse {\n");
