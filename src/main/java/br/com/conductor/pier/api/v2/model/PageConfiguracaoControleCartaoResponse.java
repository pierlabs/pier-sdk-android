...
public class PageConfiguracaoControleCartaoResponse  {
  
  @SerializedName("content")
  private List<ConfiguracaoControleCartaoResponse> content = null;
  ...
  public List<ConfiguracaoControleCartaoResponse> getContent() {
    return content;
  }
  public void setContent(List<ConfiguracaoControleCartaoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageConfiguracaoControleCartaoResponse {\n");
