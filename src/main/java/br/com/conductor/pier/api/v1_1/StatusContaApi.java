...
import br.com.conductor.pier.api.v1_1.model.StatusConta;
import br.com.conductor.pier.api.v1_1.model.PageStatusContas;
...
public class StatusContaApi {
   ...
   */
  public PageStatusContas  listarUsingGET2 (Long id, String nome, Integer flagAlteraLimite, String mensagemConsultaNegada, Integer page, Integer limit) throws ApiException {
    Object postBody = null;
