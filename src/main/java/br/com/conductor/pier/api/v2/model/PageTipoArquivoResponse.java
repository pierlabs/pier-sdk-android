...
import br.com.conductor.pier.api.v2.model.TipoArquivoResponse;
import java.util.*;
...
public class PageTipoArquivoResponse  {
  ...
  private List<TipoArquivoResponse> content = null;
  ...
  public List<TipoArquivoResponse> getContent() {
    return content;
  }
  public void setContent(List<TipoArquivoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTipoArquivoResponse {\n");
