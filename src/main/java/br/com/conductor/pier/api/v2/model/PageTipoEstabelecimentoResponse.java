...
/**
 * List of the merchant types
 **/
@ApiModel(description = "List of the merchant types")
public class PageTipoEstabelecimentoResponse  {
  
  @SerializedName("content")
  private List<TipoEstabelecimentoResponse> content = null;
  ...
  public List<TipoEstabelecimentoResponse> getContent() {
    return content;
  }
  public void setContent(List<TipoEstabelecimentoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTipoEstabelecimentoResponse {\n");
