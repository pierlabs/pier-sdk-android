 ...
 **/
@ApiModel(description = "List the Commercial Origins")
public class PageOrigemComercialResponse  {
  
  @SerializedName("content")
  private List<OrigemComercialResponse> content = null;
  ...
  public List<OrigemComercialResponse> getContent() {
    return content;
  }
  public void setContent(List<OrigemComercialResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageOrigemComercialResponse {\n");
