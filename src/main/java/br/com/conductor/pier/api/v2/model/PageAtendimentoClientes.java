...
public class PageAtendimentoClientes  {
  
  @SerializedName("content")
  private List<AtendimentoCliente> content = null;
  ...
  public List<AtendimentoCliente> getContent() {
    return content;
  }
  public void setContent(List<AtendimentoCliente> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageAtendimentoClientes {\n");
