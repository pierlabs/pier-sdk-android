...
import br.com.conductor.pier.api.v2.model.BaseResponse;
import java.util.*;
 ...
 **/
@ApiModel(description = "{{{page_base_response_description}}}")
public class PageBaseResponse  {
  
  @SerializedName("content")
  private List<BaseResponse> content = null;
  ...
  public List<BaseResponse> getContent() {
    return content;
  }
  public void setContent(List<BaseResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageBaseResponse {\n");
