 ...
 **/
@ApiModel(description = "Resposnse representation of the telephone operator resource")
public class PageOperadoraResponse  {
  
  @SerializedName("content")
  private List<OperadoraResponse> content = null;
  ...
  public List<OperadoraResponse> getContent() {
    return content;
  }
  public void setContent(List<OperadoraResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageOperadoraResponse {\n");
