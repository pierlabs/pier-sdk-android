...
import br.com.conductor.pier.api.v2.model.ContaHistoricoPagamentoResponse;
import java.util.*;
 ...
 **/
@ApiModel(description = "List of account payment")
public class PageContaHistoricoPagamentoResponse  {
  
  @SerializedName("content")
  private List<ContaHistoricoPagamentoResponse> content = null;
  ...
  public List<ContaHistoricoPagamentoResponse> getContent() {
    return content;
  }
  public void setContent(List<ContaHistoricoPagamentoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageContaHistoricoPagamentoResponse {\n");
