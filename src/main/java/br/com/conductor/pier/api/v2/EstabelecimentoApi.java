...
public class EstabelecimentoApi {
   ...
   */
  public PageMCCResponse  listarMCC (List<String> sort, Integer page, Integer limit, Long id, String descricao, Integer duracao, BigDecimal percentualMinimo, BigDecimal percentualMaximo, Long idGrupoMCC) throws ApiException {
    Object postBody = null;
