 ...
 * Card Stage List
 **/
@ApiModel(description = "Card Stage List")
public class PageEstagioCartaoResponse  {
  
  @SerializedName("content")
  private List<EstagioCartaoResponse> content = null;
  ...
  public List<EstagioCartaoResponse> getContent() {
    return content;
  }
  public void setContent(List<EstagioCartaoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageEstagioCartaoResponse {\n");
