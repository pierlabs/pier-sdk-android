...
/**
 * Lista da seguran\u00E7a mobile
 **/
@ApiModel(description = "Lista da seguran\u00E7a mobile")
public class PageSegurancaMobileResponse  {
  
  @SerializedName("content")
  private List<SegurancaMobileResponse> content = null;
  ...
  public List<SegurancaMobileResponse> getContent() {
    return content;
  }
  public void setContent(List<SegurancaMobileResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageSegurancaMobileResponse {\n");
