...
import br.com.conductor.pier.api.v2.model.PerfilResponse;
import java.util.*;
 ...
 **/
@ApiModel(description = "{{{page_perfil_response_object_description}}}")
public class PagePerfilResponse  {
  
  @SerializedName("content")
  private List<PerfilResponse> content = null;
  ...
  public List<PerfilResponse> getContent() {
    return content;
  }
  public void setContent(List<PerfilResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PagePerfilResponse {\n");
