...
import br.com.conductor.pier.api.v2.model.CartaoLoteResponse;
import java.util.*;
...
/**
 * Lista de Cart\u00F5es Lotes
 **/
@ApiModel(description = "Lista de Cart\u00F5es Lotes")
public class PageCartaoLoteResponse  {
  
  @SerializedName("content")
  private List<CartaoLoteResponse> content = null;
  ...
  public List<CartaoLoteResponse> getContent() {
    return content;
  }
  public void setContent(List<CartaoLoteResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageCartaoLoteResponse {\n");
