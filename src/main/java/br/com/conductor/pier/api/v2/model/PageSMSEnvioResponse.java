...
import br.com.conductor.pier.api.v2.model.SMSEnvioResponse;
import java.util.*;
...
public class PageSMSEnvioResponse  {
  ...
  private List<SMSEnvioResponse> content = null;
  ...
  public List<SMSEnvioResponse> getContent() {
    return content;
  }
  public void setContent(List<SMSEnvioResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageSMSEnvioResponse {\n");
