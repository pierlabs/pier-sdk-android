...
public class PageTipoTelefones  {
  
  @SerializedName("content")
  private List<TipoTelefone> content = null;
  ...
  public List<TipoTelefone> getContent() {
    return content;
  }
  public void setContent(List<TipoTelefone> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTipoTelefones {\n");
