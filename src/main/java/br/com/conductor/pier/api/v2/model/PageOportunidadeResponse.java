 ...
 **/
@ApiModel(description = "List of the opportunities")
public class PageOportunidadeResponse  {
  
  @SerializedName("content")
  private List<OportunidadeResponse> content = null;
  ...
  public List<OportunidadeResponse> getContent() {
    return content;
  }
  public void setContent(List<OportunidadeResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageOportunidadeResponse {\n");
