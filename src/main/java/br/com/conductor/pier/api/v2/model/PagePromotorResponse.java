...
public class PagePromotorResponse  {
  ...
  private List<PromotorResponse> content = null;
  ...
  public List<PromotorResponse> getContent() {
    return content;
  }
  public void setContent(List<PromotorResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PagePromotorResponse {\n");
