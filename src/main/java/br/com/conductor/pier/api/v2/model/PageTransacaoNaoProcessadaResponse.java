 ...
 **/
@ApiModel(description = "Lista de Transa\u00C3\u00A7\u00C3\u00B5es nao Processadas")
public class PageTransacaoNaoProcessadaResponse  {
  
  @SerializedName("content")
  private List<TransacaoNaoProcessadaResponse> content = null;
  ...
  public List<TransacaoNaoProcessadaResponse> getContent() {
    return content;
  }
  public void setContent(List<TransacaoNaoProcessadaResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTransacaoNaoProcessadaResponse {\n");
