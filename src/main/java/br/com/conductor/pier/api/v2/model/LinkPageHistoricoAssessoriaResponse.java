...
import br.com.conductor.pier.api.v2.model.LinkHistoricoAssessoriaResponse;
import java.util.*;
...
public class LinkPageHistoricoAssessoriaResponse  {
  
  @SerializedName("content")
  private List<LinkHistoricoAssessoriaResponse> content = null;
  ...
  public List<LinkHistoricoAssessoriaResponse> getContent() {
    return content;
  }
  public void setContent(List<LinkHistoricoAssessoriaResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class LinkPageHistoricoAssessoriaResponse {\n");
