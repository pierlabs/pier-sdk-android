 ...
 **/
@ApiModel(description = "{{{page_tipo_oportunidade_response_description}}}")
public class PageTipoOportunidadeResponse  {
  
  @SerializedName("content")
  private List<TipoOportunidadeResponse> content = null;
  ...
  public List<TipoOportunidadeResponse> getContent() {
    return content;
  }
  public void setContent(List<TipoOportunidadeResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTipoOportunidadeResponse {\n");
