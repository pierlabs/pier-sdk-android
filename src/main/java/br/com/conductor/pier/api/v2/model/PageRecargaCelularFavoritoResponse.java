...
/**
 * Lista da favoritos de recarga de celular
 **/
@ApiModel(description = "Lista da favoritos de recarga de celular")
public class PageRecargaCelularFavoritoResponse  {
  
  @SerializedName("content")
  private List<RecargaCelularFavoritoResponse> content = null;
  ...
  public List<RecargaCelularFavoritoResponse> getContent() {
    return content;
  }
  public void setContent(List<RecargaCelularFavoritoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageRecargaCelularFavoritoResponse {\n");
