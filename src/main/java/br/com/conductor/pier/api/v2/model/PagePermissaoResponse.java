...
import br.com.conductor.pier.api.v2.model.PermissaoResponse;
import java.util.*;
 ...
 **/
@ApiModel(description = "{{{page_permissao_response_object_description}}}")
public class PagePermissaoResponse  {
  
  @SerializedName("content")
  private List<PermissaoResponse> content = null;
  ...
  public List<PermissaoResponse> getContent() {
    return content;
  }
  public void setContent(List<PermissaoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PagePermissaoResponse {\n");
