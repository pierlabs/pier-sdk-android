...
import br.com.conductor.pier.api.v2.model.CdtDocumentoCredito;
import java.util.*;
...
/**
 * {{{page_documento_credito_response_description}}}
 **/
@ApiModel(description = "{{{page_documento_credito_response_description}}}")
public class PageDocumentoCreditoResponse  {
  
  @SerializedName("content")
  private List<CdtDocumentoCredito> content = null;
  ...
  public List<CdtDocumentoCredito> getContent() {
    return content;
  }
  public void setContent(List<CdtDocumentoCredito> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageDocumentoCreditoResponse {\n");
