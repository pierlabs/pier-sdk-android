...
public class GlobaltagusuarioApi {
   ...
   */
  public UsuarioResponse  alterarUsingPUT22 (Long id, UsuarioUpdateValue update) throws ApiException {
    ...
    if (update == null) {
       throw new ApiException(400, "Missing the required parameter 'update' when calling alterarUsingPUT22");
    }
   ...
   */
  public ControleSegurancaDispositivoResponse  atualizarUsingPUT1 (Long id, ControleSegurancaDispositivoUpdateValor update) throws ApiException {
    Object postBody = update;
   ...
   */
  public PageControleSegurancaDispositivoResponse  consultarUsingGET13 (Long idUsuario, List<String> sort, Integer page, Integer limit) throws ApiException {
    Object postBody = null;
    
    // verify the required parameter 'idUsuario' is set
    if (idUsuario == null) {
       throw new ApiException(400, "Missing the required parameter 'idUsuario' when calling consultarUsingGET13");
    }
   ...
   */
  public PageUsuarioResponse  listarUsingGET60 (List<String> sort, Integer page, Integer limit, String nome, String cpf, String email, String status) throws ApiException {
    Object postBody = null;
   ...
   * @return UsuarioResponse
   */
  public UsuarioResponse  salvarUsingPOST32 (UsuarioPersistencia persist) throws ApiException {
