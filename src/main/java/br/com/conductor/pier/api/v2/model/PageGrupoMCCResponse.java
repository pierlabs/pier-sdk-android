...
import br.com.conductor.pier.api.v2.model.GrupoMCCResponse;
import java.util.*;
...
/**
 * Lista de Grupos MCCs
 **/
@ApiModel(description = "Lista de Grupos MCCs")
public class PageGrupoMCCResponse  {
  
  @SerializedName("content")
  private List<GrupoMCCResponse> content = null;
  ...
  public List<GrupoMCCResponse> getContent() {
    return content;
  }
  public void setContent(List<GrupoMCCResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageGrupoMCCResponse {\n");
