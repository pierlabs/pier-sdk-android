...
public class BasePersistValue  {
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{base_dto_servidor_value}}}")
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{base_dto_usuario_value}}}")
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{base_dto_senha_value}}}")
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{base_dto_nome_base_value}}}")
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{base_dto_criado_por_value}}}")
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{base_dto_senha_criptografada_value}}}")
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{base_dto_nome_base_controle_acesso_value}}}")
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{base_dto_servidor_controle_acesso_value}}}")
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{base_dto_nome_base_usuarios_value}}}")
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{base_dto_servidor_usuarios_value}}}")
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{base_dto_flag_cluster_value}}}")
