...
import br.com.conductor.pier.api.v2.model.RiskFraudResponse;
import java.util.*;
 ...
 * List of Fraud Risk
 **/
@ApiModel(description = "List of Fraud Risk")
public class PageRiskFraudResponse  {
  
  @SerializedName("content")
  private List<RiskFraudResponse> content = null;
  ...
  public List<RiskFraudResponse> getContent() {
    return content;
  }
  public void setContent(List<RiskFraudResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageRiskFraudResponse {\n");
