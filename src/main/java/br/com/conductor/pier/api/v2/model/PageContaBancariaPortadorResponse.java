 ...
 **/
@ApiModel(description = "Representa\u00C3\u00A7\u00C3\u00A3o da resposta do recurso de conta banc\u00C3\u00A1ria portador.")
public class PageContaBancariaPortadorResponse  {
  
  @SerializedName("content")
  private List<ContaBancariaPortadorResponse> content = null;
  ...
  public List<ContaBancariaPortadorResponse> getContent() {
    return content;
  }
  public void setContent(List<ContaBancariaPortadorResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageContaBancariaPortadorResponse {\n");
