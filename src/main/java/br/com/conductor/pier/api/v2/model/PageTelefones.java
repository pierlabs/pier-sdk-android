...
public class PageTelefones  {
  
  @SerializedName("content")
  private List<Telefone> content = null;
  ...
  public List<Telefone> getContent() {
    return content;
  }
  public void setContent(List<Telefone> content) {
