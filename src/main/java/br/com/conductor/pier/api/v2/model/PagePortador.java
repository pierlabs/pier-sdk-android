...
public class PagePortador  {
  
  @SerializedName("content")
  private List<Portador> content = null;
  ...
  public List<Portador> getContent() {
    return content;
  }
  public void setContent(List<Portador> content) {
