...
import br.com.conductor.pier.api.v2.model.TransferenciaCreditoContaBancariaListaResponse;
import java.util.*;
 ...
 **/
@ApiModel(description = "List of Bank Account Credit Transfer")
public class PageTransferenciaCreditoContaBancariaResponse  {
  
  @SerializedName("content")
  private List<TransferenciaCreditoContaBancariaListaResponse> content = null;
  ...
  public List<TransferenciaCreditoContaBancariaListaResponse> getContent() {
    return content;
  }
  public void setContent(List<TransferenciaCreditoContaBancariaListaResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTransferenciaCreditoContaBancariaResponse {\n");
