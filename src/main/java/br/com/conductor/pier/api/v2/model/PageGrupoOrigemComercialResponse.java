...
public class PageGrupoOrigemComercialResponse  {
  ...
  private List<GrupoOrigemComercialResponse> content = null;
  ...
  public List<GrupoOrigemComercialResponse> getContent() {
    return content;
  }
  public void setContent(List<GrupoOrigemComercialResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageGrupoOrigemComercialResponse {\n");
