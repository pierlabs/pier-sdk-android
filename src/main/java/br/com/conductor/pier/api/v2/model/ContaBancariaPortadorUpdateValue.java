...
public class ContaBancariaPortadorUpdateValue  {
   ...
   **/
  @ApiModelProperty(value = "{{{conta_bancaria_portador_update_nome_agencia_value}}}")
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{conta_bancaria_portador_update_banco_value}}}")
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{conta_bancaria_portador_update_numero_agencia_value}}}")
   ...
   **/
  @ApiModelProperty(value = "{{{conta_bancaria_portador_update_digito_agencia_value}}}")
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{conta_bancaria_portador_update_numero_conta_value}}}")
   ...
   **/
  @ApiModelProperty(value = "{{{conta_bancaria_portador_update_digito_conta_value}}}")
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{conta_bancaria_portador_update_flag_ativo_value}}}")
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{conta_bancaria_portador_update_flag_conta_origem_doc_value}}}")
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{conta_bancaria_portador_update_flag_conta_poupanca_value}}}")
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{conta_bancaria_portador_update_favorecido_value}}}")
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{conta_bancaria_portador_update_numero_receira_federal_value}}}")
   ...
   **/
  @ApiModelProperty(value = "{{{conta_bancaria_portador_update_titularidade_value}}}")
