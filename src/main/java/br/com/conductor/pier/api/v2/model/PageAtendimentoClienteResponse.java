 ...
 **/
@ApiModel(description = "{{{page_atendimento_cliente_response_description}}}")
public class PageAtendimentoClienteResponse  {
  
  @SerializedName("content")
  private List<AtendimentoClienteResponse> content = null;
  ...
  public List<AtendimentoClienteResponse> getContent() {
    return content;
  }
  public void setContent(List<AtendimentoClienteResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageAtendimentoClienteResponse {\n");
