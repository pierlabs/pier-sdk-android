...
import br.com.conductor.pier.api.v2.model.DocumentoTemplateRequest;
...
public class DocumentosApi {
  ...
  public DocumentoResponse  salvarUsingPOST5 (DocumentoParametrosRequest persist) throws ApiException {
    ...
    try {
      ...
      if(response != null){
        return (DocumentoResponse) ApiInvoker.deserialize(response, "", DocumentoResponse.class);
      }
      else {
        return null;
      }
   ...
   */
  public DocumentoTemplateResponse  salvarUsingPOST6 (DocumentoTemplateRequest persist) throws ApiException {
    Object postBody = persist;
  ...
  public DocumentoTipoResponse  salvarUsingPOST7 (DocumentoTipoRequest persist) throws ApiException {
    ...
    try {
      String response = apiInvoker.invokeAPI(basePath, path, "POST", queryParams, postBody, headerParams, formParams, contentType);
      if(response != null){
        return (DocumentoTipoResponse) ApiInvoker.deserialize(response, "", DocumentoTipoResponse.class);
      }
      else {
        return null;
      }
