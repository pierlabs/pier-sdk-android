...
import br.com.conductor.pier.api.v2.model.Transferencia;
import java.util.*;
...
public class PageTransferencias  {
  
  @SerializedName("content")
  private List<Transferencia> content = null;
  ...
  public List<Transferencia> getContent() {
    return content;
  }
  public void setContent(List<Transferencia> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTransferencias {\n");
