...
public class AplicacaoMobilePersistValue  {
   ...
   **/
  @ApiModelProperty(value = "{{{aplicacao_mobile_persist_id_plataforma_mobile_value}}}")
   ...
   **/
  @ApiModelProperty(value = "{{{aplicacao_mobile_persist_token_value}}}")
   ...
   **/
  @ApiModelProperty(value = "{{{aplicacao_mobile_persist_cor_value}}}")
   ...
   **/
  @ApiModelProperty(value = "{{{aplicacao_mobile_persist_som_value}}}")
   ...
   **/
  @ApiModelProperty(value = "{{{aplicacao_mobile_persist_icone_value}}}")
   ...
   **/
  @ApiModelProperty(value = "{{{aplicacao_mobile_persist_certificado_base64_value}}}")
   ...
   **/
  @ApiModelProperty(value = "{{{aplicacao_mobile_persist_senha_value}}}")
