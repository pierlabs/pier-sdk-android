...
public class BaseUpdateValue  {
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{base_update_servidor_value}}}")
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{base_update_usuario_value}}}")
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{base_update_senha_value}}}")
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{base_update_nome_base_value}}}")
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{base_update_alterado_por_value}}}")
   ...
   **/
  @ApiModelProperty(value = "{{{base_update_domain_value}}}")
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{base_update_senha_criptografada_value}}}")
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{base_update_nome_base_controle_acesso_value}}}")
   ...
   **/
  @ApiModelProperty(value = "{{{base_update_id_emissor_value}}}")
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{base_update_servidor_controle_acesso_value}}}")
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{base_update_nome_base_usuarios_value}}}")
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{base_update_servidor_usuarios_value}}}")
   ...
   **/
  @ApiModelProperty(required = true, value = "{{{base_update_flag_cluster_value}}}")
