...
public class PageArquivoAUDResponse  {
  ...
  private List<ArquivoAUDResponse> content = null;
  ...
  public List<ArquivoAUDResponse> getContent() {
    return content;
  }
  public void setContent(List<ArquivoAUDResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageArquivoAUDResponse {\n");
