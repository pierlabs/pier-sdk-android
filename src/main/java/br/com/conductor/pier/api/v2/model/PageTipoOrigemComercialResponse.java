...
public class PageTipoOrigemComercialResponse  {
  ...
  private List<TipoOrigemComercialResponse> content = null;
  ...
  public List<TipoOrigemComercialResponse> getContent() {
    return content;
  }
  public void setContent(List<TipoOrigemComercialResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTipoOrigemComercialResponse {\n");
