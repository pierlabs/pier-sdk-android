...
import br.com.conductor.pier.api.v2.model.TaxasRefinanciamentoResponse;
import java.util.*;
...
public class PageTaxasRefinanciamentoResponse  {
  ...
  private List<TaxasRefinanciamentoResponse> content = null;
  ...
  public List<TaxasRefinanciamentoResponse> getContent() {
    return content;
  }
  public void setContent(List<TaxasRefinanciamentoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTaxasRefinanciamentoResponse {\n");
