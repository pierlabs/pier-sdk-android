...
import br.com.conductor.pier.api.v2.model.TipoCampanhaResponse;
import java.util.*;
 ...
 **/
@ApiModel(description = "Representa\u00C3\u00A7\u00C3\u00A3o da resposta do recurso de tipo de campanha")
public class PageTipoCampanhaResponse  {
  
  @SerializedName("content")
  private List<TipoCampanhaResponse> content = null;
  ...
  public List<TipoCampanhaResponse> getContent() {
    return content;
  }
  public void setContent(List<TipoCampanhaResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTipoCampanhaResponse {\n");
