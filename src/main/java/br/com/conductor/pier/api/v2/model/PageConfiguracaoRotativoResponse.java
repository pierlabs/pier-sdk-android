...
/**
 * List Revolving Configuration
 **/
@ApiModel(description = "List Revolving Configuration")
public class PageConfiguracaoRotativoResponse  {
  
  @SerializedName("content")
  private List<ConfiguracaoRotativoDetalheResponse> content = null;
  ...
  public List<ConfiguracaoRotativoDetalheResponse> getContent() {
    return content;
  }
  public void setContent(List<ConfiguracaoRotativoDetalheResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageConfiguracaoRotativoResponse {\n");
