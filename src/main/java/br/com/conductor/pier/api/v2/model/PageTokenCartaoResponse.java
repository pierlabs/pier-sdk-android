...
import br.com.conductor.pier.api.v2.model.TokenCartaoResponse;
import java.util.*;
...
/**
 * Lista de tokens do cart\u00E3o
 **/
@ApiModel(description = "Lista de tokens do cart\u00E3o")
public class PageTokenCartaoResponse  {
  
  @SerializedName("content")
  private List<TokenCartaoResponse> content = null;
  ...
  public List<TokenCartaoResponse> getContent() {
    return content;
  }
  public void setContent(List<TokenCartaoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTokenCartaoResponse {\n");
