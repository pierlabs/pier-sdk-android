 ...
 **/
@ApiModel(description = "List of the telephone types")
public class PageTipoTelefoneResponse  {
  
  @SerializedName("content")
  private List<TipoTelefoneResponse> content = null;
  ...
  public List<TipoTelefoneResponse> getContent() {
    return content;
  }
  public void setContent(List<TipoTelefoneResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTipoTelefoneResponse {\n");
