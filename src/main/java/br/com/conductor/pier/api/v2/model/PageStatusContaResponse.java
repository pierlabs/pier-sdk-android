 ...
 * Account Status List
 **/
@ApiModel(description = "Account Status List")
public class PageStatusContaResponse  {
  
  @SerializedName("content")
  private List<StatusContaResponse> content = null;
  ...
  public List<StatusContaResponse> getContent() {
    return content;
  }
  public void setContent(List<StatusContaResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageStatusContaResponse {\n");
