...
import br.com.conductor.pier.api.v2.model.ProdutoPacoteTarifaResponse;
import java.util.*;
 ...
 **/
@ApiModel(description = "List the product rate packages")
public class PageProdutoPacoteTarifaResponse  {
  
  @SerializedName("content")
  private List<ProdutoPacoteTarifaResponse> content = null;
  ...
  public List<ProdutoPacoteTarifaResponse> getContent() {
    return content;
  }
  public void setContent(List<ProdutoPacoteTarifaResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageProdutoPacoteTarifaResponse {\n");
