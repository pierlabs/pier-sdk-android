...
public class AddressNationalApi {
  ...
  /**
   * Consulting Address
   * This resource allows consulting addresses through the CEP
   * @param CEP CEP
   * @return EnderecoNacionalResponse
   */
  public EnderecoNacionalResponse  consultarEndereco (String CEP) throws ApiException {
