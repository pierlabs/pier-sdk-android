...
import br.com.conductor.pier.api.v2.model.BoletoListarResponse;
import java.util.*;
...
/**
 * List the bank slips registered in the system
 **/
@ApiModel(description = "List the bank slips registered in the system")
public class PageBoletoListarResponse  {
  
  @SerializedName("content")
  private List<BoletoListarResponse> content = null;
  ...
  public List<BoletoListarResponse> getContent() {
    return content;
  }
  public void setContent(List<BoletoListarResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageBoletoListarResponse {\n");
