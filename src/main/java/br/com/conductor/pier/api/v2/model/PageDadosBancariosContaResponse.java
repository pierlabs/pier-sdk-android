 ...
 **/
@ApiModel(description = "{{{page_dados_bancarios_conta_response_description}}}")
public class PageDadosBancariosContaResponse  {
  
  @SerializedName("content")
  private List<DadosBancariosContaResponse> content = null;
  ...
  public List<DadosBancariosContaResponse> getContent() {
    return content;
  }
  public void setContent(List<DadosBancariosContaResponse> content) {
