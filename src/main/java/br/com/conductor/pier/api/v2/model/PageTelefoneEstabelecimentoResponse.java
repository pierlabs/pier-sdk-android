 ...
 **/
@ApiModel(description = "{{{page_telefone_estabelecimento_response_description}}}")
public class PageTelefoneEstabelecimentoResponse  {
  
  @SerializedName("content")
  private List<TelefoneEstabelecimentoResponse> content = null;
  ...
  public List<TelefoneEstabelecimentoResponse> getContent() {
    return content;
  }
  public void setContent(List<TelefoneEstabelecimentoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTelefoneEstabelecimentoResponse {\n");
