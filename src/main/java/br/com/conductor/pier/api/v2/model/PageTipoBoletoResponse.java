...
/**
 * List of the bank slip types
 **/
@ApiModel(description = "List of the bank slip types")
public class PageTipoBoletoResponse  {
  
  @SerializedName("content")
  private List<TipoBoletoResponse> content = null;
  ...
  public List<TipoBoletoResponse> getContent() {
    return content;
  }
  public void setContent(List<TipoBoletoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTipoBoletoResponse {\n");
