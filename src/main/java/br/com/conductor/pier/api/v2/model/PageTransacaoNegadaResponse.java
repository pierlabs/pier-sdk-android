...
import br.com.conductor.pier.api.v2.model.TransacaoNegadaResponse;
import java.util.*;
 ...
 * Objeto de resposta
 **/
@ApiModel(description = "Objeto de resposta")
public class PageTransacaoNegadaResponse  {
  
  @SerializedName("content")
  private List<TransacaoNegadaResponse> content = null;
  ...
  public List<TransacaoNegadaResponse> getContent() {
    return content;
  }
  public void setContent(List<TransacaoNegadaResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTransacaoNegadaResponse {\n");
