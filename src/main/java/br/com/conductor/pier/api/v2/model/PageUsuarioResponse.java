 ...
 **/
@ApiModel(description = "{{{page_usuario_response_description}}}")
public class PageUsuarioResponse  {
  
  @SerializedName("content")
  private List<UsuarioResponse> content = null;
  ...
  public List<UsuarioResponse> getContent() {
    return content;
  }
  public void setContent(List<UsuarioResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageUsuarioResponse {\n");
