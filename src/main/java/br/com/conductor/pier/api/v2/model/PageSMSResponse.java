 ...
 * List of the SMS
 **/
@ApiModel(description = "List of the SMS")
public class PageSMSResponse  {
  
  @SerializedName("content")
  private List<NotificacaoSMSResponse> content = null;
  ...
  public List<NotificacaoSMSResponse> getContent() {
    return content;
  }
  public void setContent(List<NotificacaoSMSResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageSMSResponse {\n");
