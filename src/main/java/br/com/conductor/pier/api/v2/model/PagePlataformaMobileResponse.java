...
public class PagePlataformaMobileResponse  {
  ...
  private List<PlataformaMobileResponse> content = null;
  ...
  public List<PlataformaMobileResponse> getContent() {
    return content;
  }
  public void setContent(List<PlataformaMobileResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PagePlataformaMobileResponse {\n");
