...
public class GlobaltaxasrefinanciamentoApi {
   ...
   */
  public PageTaxasRefinanciamentoResponse  listarUsingGET51 (List<String> sort, Integer page, Integer limit, Long id, Long idProduto, String dataEntrada, String vencimento) throws ApiException {
