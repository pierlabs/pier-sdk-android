...
import br.com.conductor.pier.api.v2.model.TipoDebitoRecorrenteResponse;
import java.util.*;
...
public class PageTipoDebitoRecorrenteResponse  {
  ...
  private List<TipoDebitoRecorrenteResponse> content = null;
  ...
  public List<TipoDebitoRecorrenteResponse> getContent() {
    return content;
  }
  public void setContent(List<TipoDebitoRecorrenteResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTipoDebitoRecorrenteResponse {\n");
