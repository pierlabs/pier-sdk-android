...
/**
 * List of the status opportunity
 **/
@ApiModel(description = "List of the status opportunity")
public class PageStatusOportunidadeResponse  {
  
  @SerializedName("content")
  private List<StatusOportunidadeResponse> content = null;
  ...
  public List<StatusOportunidadeResponse> getContent() {
    return content;
  }
  public void setContent(List<StatusOportunidadeResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageStatusOportunidadeResponse {\n");
