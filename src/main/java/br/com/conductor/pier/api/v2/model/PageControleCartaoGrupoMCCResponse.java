...
/**
 * Lista de Controles de cart\u00E3o por grupo mcc.
 **/
@ApiModel(description = "Lista de Controles de cart\u00E3o por grupo mcc.")
public class PageControleCartaoGrupoMCCResponse  {
  
  @SerializedName("content")
  private List<ControleCartaoGrupoMCCResponse> content = null;
  ...
  public List<ControleCartaoGrupoMCCResponse> getContent() {
    return content;
  }
  public void setContent(List<ControleCartaoGrupoMCCResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageControleCartaoGrupoMCCResponse {\n");
