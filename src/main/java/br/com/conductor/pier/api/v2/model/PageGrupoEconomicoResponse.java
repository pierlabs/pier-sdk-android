 ...
 **/
@ApiModel(description = "Representa\u00C3\u00A7\u00C3\u00A3o da resposta do recurso de grupos encon\u00C3\u00B4micos")
public class PageGrupoEconomicoResponse  {
  
  @SerializedName("content")
  private List<GrupoEconomicoResponse> content = null;
  ...
  public List<GrupoEconomicoResponse> getContent() {
    return content;
  }
  public void setContent(List<GrupoEconomicoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageGrupoEconomicoResponse {\n");
