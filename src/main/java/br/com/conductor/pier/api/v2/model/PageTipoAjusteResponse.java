...
/**
 * List of the adjustment types
 **/
@ApiModel(description = "List of the adjustment types")
public class PageTipoAjusteResponse  {
  
  @SerializedName("content")
  private List<TipoAjusteResponse> content = null;
  ...
  public List<TipoAjusteResponse> getContent() {
    return content;
  }
  public void setContent(List<TipoAjusteResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTipoAjusteResponse {\n");
