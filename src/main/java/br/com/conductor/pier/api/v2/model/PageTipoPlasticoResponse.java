...
public class PageTipoPlasticoResponse  {
  
  @SerializedName("content")
  private List<TipoPlasticoResponse> content = null;
  ...
  public List<TipoPlasticoResponse> getContent() {
    return content;
  }
  public void setContent(List<TipoPlasticoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTipoPlasticoResponse {\n");
