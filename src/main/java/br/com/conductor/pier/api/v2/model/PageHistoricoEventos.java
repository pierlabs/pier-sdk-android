...
import br.com.conductor.pier.api.v2.model.HistoricoEventos;
import java.util.*;
...
public class PageHistoricoEventos  {
  
  @SerializedName("content")
  private List<HistoricoEventos> content = null;
  ...
  public List<HistoricoEventos> getContent() {
    return content;
  }
  public void setContent(List<HistoricoEventos> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageHistoricoEventos {\n");
