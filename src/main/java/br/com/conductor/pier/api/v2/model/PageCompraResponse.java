...
import br.com.conductor.pier.api.v2.model.CompraResponse;
import java.util.*;
 ...
 **/
@ApiModel(description = "{{{page_compra_response_description}}}")
public class PageCompraResponse  {
  
  @SerializedName("content")
  private List<CompraResponse> content = null;
  ...
  public List<CompraResponse> getContent() {
    return content;
  }
  public void setContent(List<CompraResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageCompraResponse {\n");
