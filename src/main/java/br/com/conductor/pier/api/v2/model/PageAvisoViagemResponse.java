...
/**
 * List of travel notification
 **/
@ApiModel(description = "List of travel notification")
public class PageAvisoViagemResponse  {
  
  @SerializedName("content")
  private List<AvisoViagemResponse> content = null;
  ...
  public List<AvisoViagemResponse> getContent() {
    return content;
  }
  public void setContent(List<AvisoViagemResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageAvisoViagemResponse {\n");
