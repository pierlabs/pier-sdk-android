...
public class PageDispositivoResponse  {
  ...
  private List<DispositivoResponse> content = null;
  ...
  public List<DispositivoResponse> getContent() {
    return content;
  }
  public void setContent(List<DispositivoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageDispositivoResponse {\n");
