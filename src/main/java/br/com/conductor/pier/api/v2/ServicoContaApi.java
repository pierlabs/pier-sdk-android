...
public class ServicoContaApi {
   ...
   * @return Object
   */
  public Object  desativarServicoConta (Long id) throws ApiException {
    Object postBody = null;
    
    // verify the required parameter 'id' is set
    if (id == null) {
       throw new ApiException(400, "Missing the required parameter 'id' when calling desativarServicoConta");
    }
   ...
   */
  public PageServicoContaResponse  listarServicosContas (List<String> sort, Integer page, Integer limit, Long idConta, Long idTipoServico) throws ApiException {
    Object postBody = null;
   ...
   * @return Object
   */
  public Object  salvarServicoConta (RepresentaoDaEntradaDoRecursoDeCadastrarUmServioConta servicoContaPersist) throws ApiException {
    Object postBody = servicoContaPersist;
    
    // verify the required parameter 'servicoContaPersist' is set
    if (servicoContaPersist == null) {
       throw new ApiException(400, "Missing the required parameter 'servicoContaPersist' when calling salvarServicoConta");
    }
