 ...
 **/
@ApiModel(description = "{{{page_estabelecimento_response_description}}}")
public class PageEstabelecimentoResponse  {
  
  @SerializedName("content")
  private List<EstabelecimentoResponse> content = null;
  ...
  public List<EstabelecimentoResponse> getContent() {
    return content;
  }
  public void setContent(List<EstabelecimentoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageEstabelecimentoResponse {\n");
