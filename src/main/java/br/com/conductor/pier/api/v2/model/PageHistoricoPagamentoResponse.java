 ...
 **/
@ApiModel(description = "List of the payments")
public class PageHistoricoPagamentoResponse  {
  
  @SerializedName("content")
  private List<HistoricoPagamentoResponse> content = null;
  ...
  public List<HistoricoPagamentoResponse> getContent() {
    return content;
  }
  public void setContent(List<HistoricoPagamentoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageHistoricoPagamentoResponse {\n");
