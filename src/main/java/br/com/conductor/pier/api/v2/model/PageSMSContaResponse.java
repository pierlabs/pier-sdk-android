...
import br.com.conductor.pier.api.v2.model.SMSContaResponse;
import java.util.*;
...
/**
 * Lista os servi\u00E7os SMS ativos de uma conta
 **/
@ApiModel(description = "Lista os servi\u00E7os SMS ativos de uma conta")
public class PageSMSContaResponse  {
  
  @SerializedName("content")
  private List<SMSContaResponse> content = null;
  ...
  public List<SMSContaResponse> getContent() {
    return content;
  }
  public void setContent(List<SMSContaResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageSMSContaResponse {\n");
