 ...
 **/
@ApiModel(description = "{{{page_documento_response_description}}}")
public class PageDocumentoResponse  {
  
  @SerializedName("content")
  private List<DocumentoResponse> content = null;
  ...
  public List<DocumentoResponse> getContent() {
    return content;
  }
  public void setContent(List<DocumentoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageDocumentoResponse {\n");
