...
public class PageDocumentoTemplateResponse  {
  ...
  private List<DocumentoTemplateResponse> content = null;
  ...
  public List<DocumentoTemplateResponse> getContent() {
    return content;
  }
  public void setContent(List<DocumentoTemplateResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageDocumentoTemplateResponse {\n");
