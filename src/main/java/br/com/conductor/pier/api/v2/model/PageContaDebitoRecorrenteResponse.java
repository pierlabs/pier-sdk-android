...
public class PageContaDebitoRecorrenteResponse  {
  ...
  private List<ContaDebitoRecorrenteResponse> content = null;
  ...
  public List<ContaDebitoRecorrenteResponse> getContent() {
    return content;
  }
  public void setContent(List<ContaDebitoRecorrenteResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageContaDebitoRecorrenteResponse {\n");
