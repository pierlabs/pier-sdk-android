 ...
 * Bank list
 **/
@ApiModel(description = "Bank list")
public class PageBancoResponse  {
  
  @SerializedName("content")
  private List<BancoResponse> content = null;
  ...
  public List<BancoResponse> getContent() {
    return content;
  }
  public void setContent(List<BancoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageBancoResponse {\n");
