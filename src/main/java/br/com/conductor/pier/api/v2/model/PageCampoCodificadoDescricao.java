...
public class PageCampoCodificadoDescricao  {
  
  @SerializedName("content")
  private List<CampoCodificadoDescricaoResponse> content = null;
  ...
  public List<CampoCodificadoDescricaoResponse> getContent() {
    return content;
  }
  public void setContent(List<CampoCodificadoDescricaoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageCampoCodificadoDescricao {\n");
