...
/**
 * List of the telephones
 **/
@ApiModel(description = "List of the telephones")
public class PageTelefoneResponse  {
  
  @SerializedName("content")
  private List<TelefoneResponse> content = null;
  ...
  public List<TelefoneResponse> getContent() {
    return content;
  }
  public void setContent(List<TelefoneResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTelefoneResponse {\n");
