...
public class PlataformaMobileApi {
   ...
   */
  public PagePlataformaMobileResponse  listarUsingGET19 (List<String> sort, Integer page, Integer limit, String nome) throws ApiException {
   ...
   * @return PlataformaMobileResponse
   */
  public PlataformaMobileResponse  salvarUsingPOST14 (PlataformaMobilePersist persist) throws ApiException {
