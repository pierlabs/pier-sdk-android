...
public class OperacaoBancariaPersist  {
   ...
   **/
  @ApiModelProperty(required = true, value = "C\u00F3digo identificador do tipo de opera\u00E7\u00E3o banc\u00E1ria")
   ...
   **/
  @ApiModelProperty(required = true, value = "Valor da opera\u00E7\u00E3o banc\u00E1ria")
   ...
   **/
  @ApiModelProperty(required = true, value = "Identificador da conta banc\u00E1ria")
