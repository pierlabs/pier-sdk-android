...
/**
 * List of the PersonDetailResponse
 **/
@ApiModel(description = "List of the PersonDetailResponse")
public class PagePessoaDetalheResponse  {
  ...
  public String toString()  {
    ...
    sb.append("class PagePessoaDetalheResponse {\n");
