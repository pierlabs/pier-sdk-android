 ...
 **/
@ApiModel(description = "{{{page_inscricao_apn_resposta_descricao}}}")
public class PageInscricaoAPNResponse  {
  
  @SerializedName("content")
  private List<InscricaoAPNResponse> content = null;
  ...
  public List<InscricaoAPNResponse> getContent() {
    return content;
  }
  public void setContent(List<InscricaoAPNResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageInscricaoAPNResponse {\n");
