...
public class PageTransferenciaResponse  {
  ...
  private List<TransferenciaResponse> content = null;
  ...
  public List<TransferenciaResponse> getContent() {
    return content;
  }
  public void setContent(List<TransferenciaResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTransferenciaResponse {\n");
