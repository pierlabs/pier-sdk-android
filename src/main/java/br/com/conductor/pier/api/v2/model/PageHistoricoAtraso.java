...
import br.com.conductor.pier.api.v2.model.HistoricoAtrasoFaturaResponse;
import java.util.*;
...
public class PageHistoricoAtraso  {
  
  @SerializedName("content")
  private List<HistoricoAtrasoFaturaResponse> content = null;
  ...
  public List<HistoricoAtrasoFaturaResponse> getContent() {
    return content;
  }
  public void setContent(List<HistoricoAtrasoFaturaResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageHistoricoAtraso {\n");
