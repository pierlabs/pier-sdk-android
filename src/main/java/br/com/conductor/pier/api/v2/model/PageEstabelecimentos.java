...
public class PageEstabelecimentos  {
  
  @SerializedName("content")
  private List<Estabelecimento> content = null;
  ...
  public List<Estabelecimento> getContent() {
    return content;
  }
  public void setContent(List<Estabelecimento> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageEstabelecimentos {\n");
