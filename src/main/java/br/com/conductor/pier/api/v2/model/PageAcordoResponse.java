 ...
 * List of Agreements
 **/
@ApiModel(description = "List of Agreements")
public class PageAcordoResponse  {
  
  @SerializedName("content")
  private List<AcordoResponse> content = null;
  ...
  public List<AcordoResponse> getContent() {
    return content;
  }
  public void setContent(List<AcordoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageAcordoResponse {\n");
