...
public class StatusParametroApi {
   ...
   */
  public PageStatusImpressaoResponse  listarUsingGET23 (List<String> sort, Integer page, Integer limit, Long id, String nome) throws ApiException {
    Object postBody = null;
