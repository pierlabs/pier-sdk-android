...
/**
 * List of Advisory Historic
 **/
@ApiModel(description = "List of Advisory Historic")
public class PageHistoricoAssessoriaResponse  {
  
  @SerializedName("content")
  private List<HistoricoAssessoriaResponse> content = null;
  ...
  public List<HistoricoAssessoriaResponse> getContent() {
    return content;
  }
  public void setContent(List<HistoricoAssessoriaResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageHistoricoAssessoriaResponse {\n");
