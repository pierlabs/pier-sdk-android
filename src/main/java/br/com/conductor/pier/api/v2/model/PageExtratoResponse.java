...
import br.com.conductor.pier.api.v2.model.ExtratoResponse;
import java.util.*;
...
/**
 * Extrato da conta digital
 **/
@ApiModel(description = "Extrato da conta digital")
public class PageExtratoResponse  {
  
  @SerializedName("content")
  private List<ExtratoResponse> content = null;
  ...
  public List<ExtratoResponse> getContent() {
    return content;
  }
  public void setContent(List<ExtratoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageExtratoResponse {\n");
