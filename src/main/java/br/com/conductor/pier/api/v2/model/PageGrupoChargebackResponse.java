...
import br.com.conductor.pier.api.v2.model.GrupoChargebackResponse;
import java.util.*;
...
public class PageGrupoChargebackResponse  {
  ...
  private List<GrupoChargebackResponse> content = null;
  ...
  public List<GrupoChargebackResponse> getContent() {
    return content;
  }
  public void setContent(List<GrupoChargebackResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageGrupoChargebackResponse {\n");
