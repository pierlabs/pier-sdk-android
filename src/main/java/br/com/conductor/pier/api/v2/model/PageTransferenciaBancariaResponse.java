 ...
 **/
@ApiModel(description = "{{{page_transferencia_bancaria_response_description}}}")
public class PageTransferenciaBancariaResponse  {
  
  @SerializedName("content")
  private List<TransferenciaBancariaResponse> content = null;
  ...
  public List<TransferenciaBancariaResponse> getContent() {
    return content;
  }
  public void setContent(List<TransferenciaBancariaResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTransferenciaBancariaResponse {\n");
