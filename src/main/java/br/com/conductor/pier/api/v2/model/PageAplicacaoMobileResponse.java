...
public class PageAplicacaoMobileResponse  {
  ...
  private List<AplicacaoMobileResponse> content = null;
  ...
  public List<AplicacaoMobileResponse> getContent() {
    return content;
  }
  public void setContent(List<AplicacaoMobileResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageAplicacaoMobileResponse {\n");
