...
/**
 * List of the OperationCreditor
 **/
@ApiModel(description = "List of the OperationCreditor")
public class PageOperacaoCredorResponse  {
  
  @SerializedName("content")
  private List<OperacaoCredorResponse> content = null;
  ...
  public List<OperacaoCredorResponse> getContent() {
    return content;
  }
  public void setContent(List<OperacaoCredorResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageOperacaoCredorResponse {\n");
