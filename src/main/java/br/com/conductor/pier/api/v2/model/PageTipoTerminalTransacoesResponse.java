...
import br.com.conductor.pier.api.v2.model.TipoTerminalTransacoesResponse;
import java.util.*;
 ...
 * Lista de transa\u00E7\u00F5es
 **/
@ApiModel(description = "Lista de transa\u00E7\u00F5es")
public class PageTipoTerminalTransacoesResponse  {
  
  @SerializedName("content")
  private List<TipoTerminalTransacoesResponse> content = null;
  ...
  public List<TipoTerminalTransacoesResponse> getContent() {
    return content;
  }
  public void setContent(List<TipoTerminalTransacoesResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTipoTerminalTransacoesResponse {\n");
