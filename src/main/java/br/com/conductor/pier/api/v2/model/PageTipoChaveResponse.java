...
import br.com.conductor.pier.api.v2.model.TipoChaveResponse;
import java.util.*;
...
/**
 * Page type key description
 **/
@ApiModel(description = "Page type key description")
public class PageTipoChaveResponse  {
  
  @SerializedName("content")
  private List<TipoChaveResponse> content = null;
  ...
  public List<TipoChaveResponse> getContent() {
    return content;
  }
  public void setContent(List<TipoChaveResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTipoChaveResponse {\n");
