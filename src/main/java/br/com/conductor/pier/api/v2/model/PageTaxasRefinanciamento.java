...
import br.com.conductor.pier.api.v2.model.TaxasRefinanciamento;
import java.util.*;
...
public class PageTaxasRefinanciamento  {
  
  @SerializedName("content")
  private List<TaxasRefinanciamento> content = null;
  ...
  public List<TaxasRefinanciamento> getContent() {
    return content;
  }
  public void setContent(List<TaxasRefinanciamento> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTaxasRefinanciamento {\n");
