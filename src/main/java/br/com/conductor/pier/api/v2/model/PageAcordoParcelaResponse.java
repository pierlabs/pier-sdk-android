...
public class PageAcordoParcelaResponse  {
  ...
  private List<ParcelaAcordoResponse> content = null;
  ...
  public List<ParcelaAcordoResponse> getContent() {
    return content;
  }
  public void setContent(List<ParcelaAcordoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageAcordoParcelaResponse {\n");
