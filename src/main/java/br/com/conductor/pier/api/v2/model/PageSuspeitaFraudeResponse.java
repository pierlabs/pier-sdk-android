...
/**
 * Objeto page que represensa a pagina\u00E7\u00E3o do response da suspeita de fraude
 **/
@ApiModel(description = "Objeto page que represensa a pagina\u00E7\u00E3o do response da suspeita de fraude")
public class PageSuspeitaFraudeResponse  {
  
  @SerializedName("content")
  private List<SuspeitaFraudeResponse> content = null;
  ...
  public List<SuspeitaFraudeResponse> getContent() {
    return content;
  }
  public void setContent(List<SuspeitaFraudeResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageSuspeitaFraudeResponse {\n");
