...
import br.com.conductor.pier.api.v2.model.StatusCnabSumarizadoResponse;
import java.util.*;
...
public class PageStatusCnabSumarizadoResponse  {
  
  @SerializedName("content")
  private List<StatusCnabSumarizadoResponse> content = null;
  ...
  public List<StatusCnabSumarizadoResponse> getContent() {
    return content;
  }
  public void setContent(List<StatusCnabSumarizadoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageStatusCnabSumarizadoResponse {\n");
