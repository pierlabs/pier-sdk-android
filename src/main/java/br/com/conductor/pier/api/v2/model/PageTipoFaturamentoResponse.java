...
public class PageTipoFaturamentoResponse  {
  ...
  private List<TipoFaturamentoResponse> content = null;
  ...
  public List<TipoFaturamentoResponse> getContent() {
    return content;
  }
  public void setContent(List<TipoFaturamentoResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageTipoFaturamentoResponse {\n");
