...
public class PageConfiguracaoSMSResponse  {
  
  @SerializedName("content")
  private List<ConfiguracaoSMSResponse> content = null;
  ...
  public List<ConfiguracaoSMSResponse> getContent() {
    return content;
  }
  public void setContent(List<ConfiguracaoSMSResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageConfiguracaoSMSResponse {\n");
