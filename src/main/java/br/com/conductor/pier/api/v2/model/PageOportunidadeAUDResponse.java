...
import br.com.conductor.pier.api.v2.model.OportunidadeAUDResponse;
import java.util.*;
...
/**
 * List the auditorials of the opportunity
 **/
@ApiModel(description = "List the auditorials of the opportunity")
public class PageOportunidadeAUDResponse  {
  
  @SerializedName("content")
  private List<OportunidadeAUDResponse> content = null;
  ...
  public List<OportunidadeAUDResponse> getContent() {
    return content;
  }
  public void setContent(List<OportunidadeAUDResponse> content) {
  ...
  public String toString()  {
    ...
    sb.append("class PageOportunidadeAUDResponse {\n");
